<!--
-------------------------------------------------------------
 Topic		: Exemple PHP traitement de la rÈponse de paiement
 Version 	: P617

	Dans cet exemple, les donnÈes de la transaction	sont
	dÈcryptÈes et affichÈes sur le navigateur de l'internaute.
...
if(isset($_POST['DATA']))
{
  ...
  if (( $code == "" ) && ( $error == "" ) )
	...
	// OK, affichage des champs de la rÈponse
	else {
		...
		if($bank_response_code == "00"){
			...
			print("il contient le re√ßu de la transaction et le d√©tail de votre commande</p>");
