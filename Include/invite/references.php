					...
					while ($donnees = mysql_fetch_array($retour))
						{
							...
							{
								echo'
								<span style="margin-left:10%;"><a href="index.php?page=admin_ref&mode=modifier&id='.$donnees['id'].'">Modifier</a> - 
								<a href="index.php?page=admin_ref&mode=delete&id='.$donnees['id'].'">Supprimer</a></span>';
							}
